...
(goal-src "pc/progress/progress-pc-h.gc" "progress" "pckernel")
(goal-src "pc/progress/progress-pc-aspect-ratio-adjustments.gc" "progress-pc-h" "pckernel")
(goal-src "pc/progress/progress-generic-pc-h.gc" "progress-pc-aspect-ratio-adjustments" "pckernel")
(goal-src "pc/progress/progress-generic-draw-pc.gc" "progress-generic-pc-h" "pckernel")
(goal-src "pc/progress/progress-static-pc.gc" "progress-generic-draw-pc" "pckernel")
(goal-src "pc/progress/progress-pc.gc" "progress-pc-aspect-ratio-adjustments" "pckernel")
